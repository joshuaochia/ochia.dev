...
const AboutMyWork = () => {
    ...
    return (
        ...
        <div className="container">
            ...
            <div onClick={firstHandler} className={`${classes['QAcontent']} content col-lg-10 offset-lg-1`}>
                <div className="QA-content-title row">
                    ...
                    <div className="col-lg-1">
                        <h4 className="plus-icon"><i className="fas fa-plus"></i></h4>
                        <h4 className="plus-icon hidden"><i className="fas fa-minus"></i></h4>
                    </div>
                </div>

                {firstQuestion && <div className="QA-content-body pt-2 hidden">
                    <p>8:00 am - 8:00 pm (GMT+8)</p>
                </div> }
            </div>

            <div  onClick={secondHandler} className={`${classes['QAcontent']} content col-lg-10 offset-lg-1`}>
                <div className="QA-content-title row">
                ...
                {secondQuestion && <div className="QA-content-body pt-2 hidden">
                    <p>Minimum of 15$/hr</p>
                </div>}
            </div>

            <div  onClick={thirdHandler} className={`${classes['QAcontent']} content col-lg-10 offset-lg-1`}>
                <div className="QA-content-title row">
                 ...
                 {thirdQuestion && <div className="QA-content-body pt-2 hidden">
