export const portfolioData = [
  {
    ...
    bgClass: "bg-prink",
    imgSrc: "/assets/img/work/grafana2.png",
    subtitle: "Lambda, API Gateway, ERC",
    title: "Terraform server and management for Grafana",
    target: "#portfolio-1",
    category: ["AWS"],
    project: "Server Monitoring",
    languages: ["HCL"],
    client: "Smidige",
    previewLink: "https://grafana.smidige.com/",
    previewName: "Grafana",
    desc: [
      `I demonstrate my proficiency in architecting and managing Grafana environments on the AWS cloud using Terraform. I've meticulously engineered an Automated Machine Image (AMI) for Grafana servers, specifically optimized for AWS infrastructure, ensuring seamless deployment and consistency across AWS environments.`,

      `Key Achievements:`,
      `- AWS-Optimized AMI for Grafana: Developed a tailored AMI for Grafana, optimized to leverage AWS services and capabilities. `,
      `- Alert Management with Terraform on AWS CloudWatch: Implemented a robust alerting system using Terraform integrated with AWS CloudWatch`,
      `- AWS Network Management with Terraform: Utilized Terraform to define and manage the AWS network infrastructure supporting Grafana`,
      `- Infrastructure as Code (IaC) on AWS: Codified the entire Grafana setup using Terraform, embracing the AWS-native syntax.`,

      "Why Terraform on AWS?",
      ` `,
      `By leveraging Terraform for Grafana deployment on AWS, I bring together the strengths of Terraform's IaC paradigm and AWS's extensive cloud services. This combination allows for the creation of a consistent, scalable, and easily modifiable infrastructure on AWS, aligning Grafana deployment with the agility and scalability offered by AWS.`,
    ],
  },
  {
    id: 10,
    class: "isotop-item logo",
    bgClass: "bg-prink",
    imgSrc: "/assets/img/work/sechub.png",
    subtitle: "Lambda, API Gateway, ERC",
    title: "CIS and AWS foundational security hub finding remediation",
    target: "#portfolio-1",
    category: ["AWS"],
    project: "Web tool",
    ...
    previewName: "",
    desc: [
      ` I showcase my proficiency in strengthening the security posture of AWS environments by addressing and remediating findings from the Center for Internet Security (CIS) and AWS Foundational Security Hub. I have successfully transformed an initial landscape with 68 security errors into a fortified system with only a handful of remaining issues.`,

      `Key Achievements:`,
      ``,

      `- Error Reduction from 68 to Minimal: Initiated a comprehensive security audit based on CIS and AWS Foundational Security Hub benchmarks, identifying and prioritizing 68 security errors spanning permissions, encryption, IAM users, and other critical areas.`,
      `- Permissions Refinement: Addressed and fine-tuned permissions across the AWS environment to align with the principle of least privilege.`,
      `- Encryption Best Practices: Implemented robust encryption strategies for data at rest and in transit, adhering to industry best practices and AWS recommendations`,
      ``,
      `Why CIS and AWS Foundational Security Hub?`,
      `The CIS benchmarks and AWS Foundational Security Hub serve as comprehensive guides to fortify AWS environments against common security issues. By systematically addressing and remediating findings based on these benchmarks, I've not only reduced the attack surface but also established a robust foundation for ongoing security in alignment with industry standards.`,
    ],
  },

  {
    ...
    class: "isotop-item logo",
    bgClass: "bg-prink",
    imgSrc: "/assets/img/work/grafana1.png",
    subtitle: "Lambda, API Gateway, ERC",
    title: "Grafana on EC2",
    target: "#portfolio-1",
    category: ["AWS"],
    project: "Web tool",
    languages: ["Javascript"],
    ...
    previewName: "",
    desc: [
      `I demonstrate my proficiency in deploying Grafana on AWS EC2 instances and fine-tuning the configuration to align with specific company requirements. This includes not only the installation of Grafana but also a meticulous optimization process to ensure optimal performance and functionality.`,

      `Key Achievements:`,
      ``,
      `- Grafana Installation on AWS EC2: Executed a seamless deployment of Grafana on Amazon EC2 instances, leveraging the flexibility and scalability of AWS`,
      `- Alert Setup on Slack: Implemented a robust alerting mechanism within Grafana, integrated seamlessly with Slack for real-time notifications. Configured alert channels, message templates, and other settings.`,
      `- Screenshot Integration in Alerts: Enhanced alerting functionality by incorporating screenshots into Slack notifications.`,

      ` `,
      `Why Grafana on AWS EC2 with Slack?`,
      `Deploying Grafana on AWS EC2 provides a scalable and cost-effective solution for monitoring and visualization needs. Integrating Slack for alerting ensures that key stakeholders receive immediate notifications, fostering a proactive approach to system monitoring.`,
    ],
  },

  {
    ...
    class: "isotop-item logo",
    bgClass: "bg-prink",
    imgSrc: "/assets/img/work/lambda1.png",
    subtitle: "Lambda, API Gateway, ERC",
  ...
  },
  {
    ...
    bgClass: "bg-catkrill",
    imgSrc: "/assets/img/work/lambda2.jpg",
  ...
  },
  {
    ...
    bgClass: "bg-catkrill",
    imgSrc: "/assets/img/work/amp.png",
